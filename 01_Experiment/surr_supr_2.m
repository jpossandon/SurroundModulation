...
elseif strcmp(testType,'Experiment')
    ...
    fileMAT             = sprintf('E354v2_S%04d.mat',str2num(answer{1}));
    if exist(fullfile(resultPATH,fileMAT))
      ...
      switch selection
          ...
          case 'Save as new'
              fileMAT = sprintf('E354v2_S%04d_%s.mat',str2num(answer{1}),datestr(now,'HH_MM')); 
...
Screen('Preference', 'SkipSyncTests', 0); % change to 0
